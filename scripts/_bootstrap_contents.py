...
def after_install(options, home_dir):
    subprocess.check_call([join(home_dir, 'bin', 'pip'),
                     'install', '--allow-external', 'pybonjour', '--allow-unverified', 'pybonjour', '--process-dependency-links', '-U', '-e', 'git+https://github.com/justinseanmartin/PonyDebugger.git#egg=ponydebugger'])
